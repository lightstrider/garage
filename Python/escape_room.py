        ...
        if inv_choice not in inventory:
          ...
          if use_choice not in room_look:
            ...
            #'normal' escape room things
              ...
              examine_dict['solved puzzle'] = 'After working at the puzzle for just shy of an hour, it seems to want you to look up the word \'Escape\' in a dictionary...'
...
##############################################################
Woah...are you using the axe on the door? You know...you know
there's a key in the room right? A key that opens the door?
The axe isn't even part of the game....
Why don't we put down the axe and go back to solving puzzles?
##############################################################
...
You hack at the last remaining planks of wood, only but a few still impetuously stand...
Upon every stroke, you let out a hearty laugh, celebrating your subversion of the developer's wishes
